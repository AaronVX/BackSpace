...
import com.group8.backspace.presentation.track_flights.StatusDetail;
...
public class FlightListAdapter extends BaseAdapter {
    ...
    public FlightListAdapter(Context applicationContext, int[] Item, String[] SubItem , int[] flags) { //constructor takes in and sets info
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) { //creates view
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) { //makes a button, that when pressed goes to StatusDetail.class the title of the textview clicked
                Intent intent = new Intent(v.getContext(), StatusDetail.class);
